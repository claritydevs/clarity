...
This document provides guidelines for internationalization of the Clarity Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `clarity_en.ts` remains unchanged.
