...
Clarity Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ClarityMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as Clarity Core, where everyone uses
...
pay attention to for reviewers of Clarity Core code.

General Clarity Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Clarity Core uses tinyformat, which is type safe. Leave them out to avoid confusion
