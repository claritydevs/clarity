...
unlocked to sign the Clarity-Qt.app bundle.
...
allowing somebody to distribute a Clarity-Qt.app or clarity-qt-setup.exe with a valid
...
that the clarity-qt.exe file inside the installer had not been tampered with.
