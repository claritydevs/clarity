...
#ifndef CLARITY_HASH_H
#define CLARITY_HASH_H
...
/* ----------- Clarity Hash ------------------------------------------------- */
/** A hasher class for Clarity's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Clarity's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
