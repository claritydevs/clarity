...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Clarity Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  clarity-cli [options] <command> [params]  " + _("Send command to Clarity Core") + "\n" +
                  "  clarity-cli [options] help                " + _("List commands") + "\n" +
                  "  clarity-cli [options] help <command>      " + _("Get help for a command") + "\n";
