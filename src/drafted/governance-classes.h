 ...
 *
 *   // network
 *   CClarityNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.clarity.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CClarityNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CClarityNetwork(UniValue objIn)
    {
...
// // can be under: ClarityNetwork
// //   -- signature requirements : Key1(User)
// class CClarityNetworkVariable : public CGovernanceObject
// {
// private:
