...
#ifndef CLARITY_NET_H
#define CLARITY_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in Clarity,
    // because it's used in many Clarity-specific places (masternode, privatesend).
