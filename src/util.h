 ...
 */
#ifndef CLARITY_UTIL_H
#define CLARITY_UTIL_H
...
//#define ENABLE_CLARITY_DEBUG
#ifdef ENABLE_CLARITY_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const CLARITY_CONF_FILENAME;
extern const char * const CLARITY_PID_FILENAME;
...
{
    std::string s = strprintf("clarity-%s", name);
