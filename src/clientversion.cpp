 ...
 * for both clarityd and clarity-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Clarity Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/clarity/bips/blob/master/bip-0014.mediawiki) 
 */
