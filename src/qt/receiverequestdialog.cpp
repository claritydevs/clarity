...
#include "config/clarity-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatClarityURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ClarityUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatClarityURI(info));
}
