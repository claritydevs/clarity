...
#ifndef CLARITY_QT_OPTIONSMODEL_H
#define CLARITY_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Clarity client.
...
#endif // CLARITY_QT_OPTIONSMODEL_H
