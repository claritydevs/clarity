    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CLARITY-light"), QVariant("light"));
    ui->theme->addItem(QString("CLARITY-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CLARITY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CLARITY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CLARITY-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new ClarityUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->clarityAtStartup, OptionsModel::StartAtStartup);
