...
#ifndef CLARITY_QT_CLARITYUNITS_H
#define CLARITY_QT_CLARITYUNITS_H
...
/** Clarity unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ClarityUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ClarityUnits(QObject *parent);

    /** Clarity units.
      @note Source: https://en.clarity.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XMN,
...
typedef ClarityUnits::Unit ClarityUnit;

#endif // CLARITY_QT_CLARITYUNITS_H
