...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ClarityUnits::XMN),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = ClarityUnits::floorWithUnit(unit, amount, true, ClarityUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, ClarityUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, ClarityUnits::separatorAlways));
    ui->labelImmature->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, ClarityUnits::separatorAlways));
    ui->labelAnonymized->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, ClarityUnits::separatorAlways));
    ui->labelTotal->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, ClarityUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, ClarityUnits::separatorAlways));
    ui->labelWatchPending->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, ClarityUnits::separatorAlways));
    ui->labelWatchImmature->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, ClarityUnits::separatorAlways));
    ui->labelWatchTotal->setText(ClarityUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ClarityUnits::separatorAlways));
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = ClarityUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, ClarityUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), ClarityUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = ClarityUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, ClarityUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), ClarityUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(ClarityUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(ClarityUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
