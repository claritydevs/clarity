...
#define BOOST_TEST_MODULE Clarity Test Suite

#include "test_clarity.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_clarity_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
