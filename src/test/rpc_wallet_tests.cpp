...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CClarityAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CClarityAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CClarityAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CClarityAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CClarityAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CClarityAddress(arr[0].get_str()).Get() == demoAddress.Get());
