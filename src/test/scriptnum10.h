...
#ifndef CLARITY_TEST_SCRIPTNUM10_H
#define CLARITY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Clarity Core 0.10.0, for cross-comparison.
 */
public:
